...
suchai: main.o taskTest.o cmdDRP.o cmdOBC.o repoCommand.o repoData.o taskDispatcher.o taskExecuter.o taskHouskeeping.o osThread.o osDelay.o osScheduler.o osQueue.o osSemphr.o pthread_queue.o
	gcc ${WARN} -o suchai main.o taskTest.o cmdDRP.o cmdOBC.o repoCommand.o repoData.o taskDispatcher.o taskExecuter.o taskHouskeeping.o osThread.o osDelay.o osScheduler.o osQueue.o osSemphr.o pthread_queue.o -lpthread
